...
kubectl create secret docker-registry ngc-secret -n nim-ks \
...
sed -e "s|\${HF_TOKEN}|${HF_TOKEN_BASE64}|g" -e "s|\${NGC_API_KEY}|${NGC_API_KEY_BASE64}|g" ${SCRIPT_DIR}/nvidia-nim-secrets.yaml | kubectl apply -n nim-ks -f -
